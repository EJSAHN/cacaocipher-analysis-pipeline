...
from cacaocipher.panels import select_trait_enriched_panel, select_pure_id_panel
...
def run_benchmarks(
    ...
    *,
    ...
    if "TraitEnriched_32" in fixed_panels:
        panels.append(PanelSpec(name="TraitEnriched_heuristic", k=32, markers=fixed_panels["TraitEnriched_32"]))
    ...
    if "TraitEnriched_32" in fixed_panels:
        trait_panels.append(PanelSpec(name="TraitEnriched_heuristic", k=32, markers=fixed_panels["TraitEnriched_32"]))
    if "PureID_96" in fixed_panels:
...
def main() -> None:
    ...
    ap.add_argument("--out-dir", type=str, default="analysis_outputs", help="Output directory.")
    ...
    trait32 = select_trait_enriched_panel(
        geno,
        pheno,
        snp_cols,
        trait_col="PodIndex",
