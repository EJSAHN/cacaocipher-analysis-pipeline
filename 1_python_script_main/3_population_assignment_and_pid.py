...
#
# Population assignment and probability-of-identity analyses
#
...
#
# Outputs:
#   master/panel_population_assignment_accuracy.csv
#   master/panel_PID_summary.csv
#
# Optional supplementary outputs:
#   master/supplementary/S1_full_536_confusion_counts.csv
#   master/supplementary/S1_full_536_confusion_norm_by_true.csv
#   master/supplementary/S1_pureID_32_confusion_counts.csv
#   master/supplementary/S1_pureID_32_confusion_norm_by_true.csv
...
# 0) Paths
# -----------------------------
parser = argparse.ArgumentParser(description="Population assignment and PID analyses for CacaoCipher.")
parser.add_argument("--make-plots", action="store_true", help="Generate optional supplementary confusion-matrix PNG files.")
